export const projects = [
  {
   ...
   description: 'A feature-rich dating platform with distance-based matchmaking, real-time chat, video calls, and interactive games, built using the MERN stack.',
   features: [
...

{
 ...
 
 {
     ...
     features: [
         'Static layout & video thumbnails',
         'Basic navigation & homepage UI',
         'HTML page structuring practice'
     ],
     tags: ['HTML'],
